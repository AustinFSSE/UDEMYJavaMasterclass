package dev.alm.ThreadProblems;
...
class ParticipantThread extends Thread {
    ...
    public void run() {
        ...
        while (true) {
            ...
            try {
                Thread.sleep(participant.name().equals("Grace") ? 2900 : 500); // this random sleep time prevents livelock
...
public class MazeRunner {
    ...
    public static void main(String[] args) {
        ...
        Participant adam = new Participant("Adam", "Grace",
                maze, new int[]{new Random().nextInt(0,3), new Random().nextInt(0,3)});
